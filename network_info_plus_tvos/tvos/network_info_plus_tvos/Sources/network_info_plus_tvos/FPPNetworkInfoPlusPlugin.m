...
#import "./include/network_info_plus_tvos/FPPNetworkInfoPlusPlugin.h"

#import "./include/network_info_plus_tvos/FPPCaptiveNetworkInfoProvider.h"
#import "./include/network_info_plus_tvos/FPPNetworkInfo.h"
#import "./include/network_info_plus_tvos/FPPNetworkInfoProvider.h"
#import "./include/network_info_plus_tvos/getgateway.h"
...
@interface FPPNetworkInfoPlusPlugin ()
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
  // tvOS does not expose the SSID/BSSID APIs available on iOS. The provider
  // therefore reports no Wi-Fi identity while the interface-based methods
  // below continue to provide IP, netmask, broadcast and gateway addresses.
  id<FPPNetworkInfoProvider> networkInfoProvider =
      [[FPPCaptiveNetworkInfoProvider alloc] init];
